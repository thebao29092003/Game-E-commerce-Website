...
const SearchResult = () => {
  ...
  const content = isLoading ? (
    ...
    data?.gameList.length > 0 ? (data?.gameList?.map((item, index) => {
      return (
        <a
        ...
        <p style={{fontSize: "20px", fontWeight: "bold", color: "var(--main-color)"}}>Không tìm thấy kết quả</p>
    )
  );
  ...
  return (
    <div className="product-display">
      ...
      <h1>Kết quả tìm kiếm : {searchInput}</h1>
