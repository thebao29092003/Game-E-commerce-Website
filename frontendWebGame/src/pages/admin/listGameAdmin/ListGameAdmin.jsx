import "./ListgameAdmin.css";
import SideBarAdmin from "../sidebarAdmin/SideBarAdmin";
import Pagination from "../../home/pagination/Pagination";
import { icons } from "../../../assets/icons/icons";
import {useState } from "react";
import SearchGameAdmin from "../searchAdmin/SearchGameAdmin";
import { useGetGameListNewQuery} from "../../../features/homeApi/homeApiSlice";
...
const ListGameAdmin = () => {
  ...
  const content = isLoadingNewGame ? (
    <BounceLoader
      color="rgb(0, 174, 215)"
      loading={true}
      cssOverride={{
    ...
    dataNewGame?.gameList?.map((item, index) => {
      return (
        <div key={index}>
      ...
      <div className="list-game-page">
        ...
        <div className="list-game-content">
          ...
          <Pagination
            ...
            totalPage={dataNewGame?.totalPages}
